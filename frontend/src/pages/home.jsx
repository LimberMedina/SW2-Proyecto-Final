          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              ...
              <span className="block text-2xl md:text-3xl font-normal mt-2 text-blue-100">
                UAGRM - Canal Universitario
              </span>
            </h1>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Descubre, explora y aprende con nuestra extensa colección de
              contenido académico, producciones universitarias y material
              educativo de alta calidad.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/catalog"
                className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-200 shadow-lg flex items-center gap-2"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="text-gray-600 font-medium">Videos Digitales</div>
          </div>
          <div className="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="text-3xl font-bold text-green-600 mb-2">
              {stats.videosFisicos.toLocaleString()}
            </div>
            <div className="text-gray-600 font-medium">Videos Físicos</div>
          </div>
          <div className="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Últimas incorporaciones a nuestra videoteca
            </p>
          </div>
